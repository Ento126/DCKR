...
from ktDiffu.model import MLPDiffusion, KT
from ktDiffu.metrics import *
from ktDiffu.data_loader import load_data
...
parser.add_argument('--model_name', type=str, default='ktDiffu', help='name of model')
...
def main():
    ...
    model = KT(usr_emb, ent_emb, rel_emb, adj_entity, adj_relation, user_click_item_pos, args, device).to(device)
